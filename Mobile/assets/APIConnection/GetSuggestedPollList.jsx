...
export default function GetSuggestedPollList(currentPage) {
    ...
    return new Promise((resolve, reject) => {
        ...
        SecureStore.getItemAsync('Token')
            .then(token => {
                ...
                let url = `http://192.168.0.159:8080/api/v1/poll/suggested_filtered_list?sort=${SearchProp.sortedType}&limit=10&page=${currentPage}`;
                let options = {
                    method: "POST",
                    headers: {
